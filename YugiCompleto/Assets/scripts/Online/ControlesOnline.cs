...
public class ControlesOnline : MonoBehaviourPun
{
    public int indice = 0;
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.RightArrow) && juego.esJugadorUno)
        {
            base.photonView.RPC("BotonDerecha", RpcTarget.All);

        }
        if (Input.GetKeyDown(KeyCode.LeftArrow) && juego.esJugadorUno)
        {
            base.photonView.RPC("BotonIzquierda", RpcTarget.All);
        }

        if (Input.GetKeyDown(KeyCode.X) && juego.esJugadorUno)
        {
            base.photonView.RPC("BotonX", RpcTarget.All);
        ...
        if (Input.GetKeyDown(KeyCode.Space) && juego.esJugadorUno)
        {
            base.photonView.RPC("BotonEspacio", RpcTarget.All);
